  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          <span class="info-box-icon bg-info"><i class="far fa-envelope" /></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          <span class="info-box-icon bg-success"><i class="far fa-flag" /></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          <span class="info-box-icon bg-warning"><i class="far fa-copy" /></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box">
          <span class="info-box-icon bg-danger"><i class="far fa-star" /></span>
    ...
    <div class="row">
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-info">
          <span class="info-box-icon"><i class="far fa-bookmark" /></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-success">
          <span class="info-box-icon"><i class="far fa-thumbs-up" /></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-warning">
          <span class="info-box-icon"><i class="far fa-calendar-alt" /></span>
      ...
      <div class="col-md-3 col-sm-6 col-12">
        <div class="info-box bg-danger">
          <span class="info-box-icon"><i class="fas fa-comments" /></span>
        ...
        <div class="card card-primary collapsed-card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus" /> </button>
            </div>
            <!-- /.card-tools -->
          </div>
          <!-- /.card-header -->
      ...
      <div class="col-md-3">
        <div class="card card-warning">
          <div class="card-header">
            ...
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times" /> </button>
            </div>
            <!-- /.card-tools -->
          </div>
          <!-- /.card-header -->
      ...
      <div class="col-md-3">
        <div class="card card-danger">
          <div class="card-header">
            ...
            <div class="card-tools">
              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand" /> </button>
            </div>
            <!-- /.card-tools -->
          </div>
          <!-- /.card-header -->
        ...
        <div class="card card-widget widget-user-2">
          ...
          <div class="widget-user-header bg-warning">
            <div class="widget-user-image">
              <img class="img-circle elevation-2" src="/img/user7-128x128.jpg" alt="User Avatar" />
            </div>
            <!-- /.widget-user-image -->
      ...
      <div class="col-md-6">
        ...
        <div class="card card-widget">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-default btn-sm"><i class="fas fa-share" /> Share</button>
            <button type="button" class="btn btn-default btn-sm"><i class="far fa-thumbs-up" /> Like</button>
      ...
      <div class="col-md-6">
        ...
        <div class="card card-widget">
          ...
          <div class="card-body">
            ...
            <p>
              the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which
        ...
        <div class="row">
          <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card mb-2 bg-gradient-dark">
              <img class="card-img-top" src="/img/photo1.png" alt="Dist Photo 1" />
          ...
          <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card mb-2">
              <img class="card-img-top" src="/img/photo2.png" alt="Dist Photo 2" />
          ...
          <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="card mb-2">
              <img class="card-img-top" src="/img/photo3.jpg" alt="Dist Photo 3" />
