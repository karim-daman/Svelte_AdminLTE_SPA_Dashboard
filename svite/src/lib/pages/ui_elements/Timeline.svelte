        ...
        <div class="timeline">
          ...
          <div>
            ...
            <div class="timeline-item">
              <span class="time"><i class="fas fa-clock" /> 12:05</span>
          ...
          <!-- timeline item -->
          <div>
            <i class="fas fa-user bg-green" />
            <div class="timeline-item">
              <span class="time"><i class="fas fa-clock" /> 5 mins ago</span>
          ...
          <!-- timeline item -->
          <div>
            <i class="fas fa-comments bg-yellow" />
            <div class="timeline-item">
              <span class="time"><i class="fas fa-clock" /> 27 mins ago</span>
          ...
          <div>
            ...
            <div class="timeline-item">
              <span class="time"><i class="fas fa-clock" /> 2 days ago</span>
          ...
          <!-- timeline item -->
          <div>
            <i class="fas fa-video bg-maroon" />

            <div class="timeline-item">
              <span class="time"><i class="fas fa-clock" /> 5 days ago</span>

              <h3 class="timeline-header"><a href="#">Mr. Doe</a> shared a video</h3>

              <div class="timeline-body">
                <div class="embed-responsive embed-responsive-16by9">
                  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/tMWkeBIohBs" allowfullscreen />
                </div>
              </div>
              <div class="timeline-footer">
