      ...
      <div class="col-md-6">
        ...
        <div class="card">
          ...
          <div class="card-body row">
            <div class="col-md-6">
              <button type="button" class="btn btn-primary btn-block"><i class="fa fa-bell" /> .btn-block</button>
              <button type="button" class="btn btn-info btn-block btn-flat"><i class="fa fa-bell" /> .btn-block .btn-flat</button>
              <button type="button" class="btn btn-danger btn-block btn-sm"><i class="fa fa-bell" /> .btn-block .btn-sm</button>
            </div>
            <div class="col-md-6">
              <button type="button" class="btn btn-outline-primary btn-block"><i class="fa fa-bell" /> .btn-block</button>
              <button type="button" class="btn btn-outline-info btn-block btn-flat"><i class="fa fa-book" /> .btn-block .btn-flat</button>
              <button type="button" class="btn btn-outline-danger btn-block btn-sm"><i class="fa fa-book" /> .btn-block .btn-sm</button>
            </div>
          </div>
        </div>
        <!-- /.card -->
