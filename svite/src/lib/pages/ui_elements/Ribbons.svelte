            ...
            <div class="card-body">
                ...
                <div class="col-sm-4">
                  <div class="position-relative p-3 bg-gray" style="height: 180px">
                    <div class="ribbon-wrapper ribbon-lg">
                      <div class="ribbon bg-info">Ribbon Large</div>
                    </div>
                    Ribbon Large<br />
                    <small>.ribbon-wrapper.ribbon-lg .ribbon</small>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="position-relative p-3 bg-gray" style="height: 180px">
                    <div class="ribbon-wrapper ribbon-xl">
                      <div class="ribbon bg-secondary">Ribbon Extra Large</div>
                    </div>
              ...
              <div class="row mt-4">
                ...
                <div class="col-sm-4">
                  <div class="position-relative p-3 bg-gray" style="height: 180px">
                    <div class="ribbon-wrapper ribbon-xl">
                      <div class="ribbon bg-warning text-lg">Ribbon</div>
                    </div>
              ...
              <div class="row mt-4">
                <div class="col-sm-4">
                  <div class="position-relative">
                    <img src="/img/photo1.png" alt="Photo 1" class="img-fluid" />
                    <div class="ribbon-wrapper ribbon-lg">
                      <div class="ribbon bg-success text-lg">Ribbon</div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="position-relative">
                    <img src="/img/photo2.png" alt="Photo 2" class="img-fluid" />
                    <div class="ribbon-wrapper ribbon-xl">
                      <div class="ribbon bg-warning text-lg">Ribbon</div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="position-relative" style="min-height: 180px;">
                    <img src="/img/photo3.jpg" alt="Photo 3" class="img-fluid" />
                    <div class="ribbon-wrapper ribbon-xl">
                      <div class="ribbon bg-danger text-xl">Ribbon</div>
                    </div>
                  </div>
