                ...
                <div class="post">
                  <div class="user-block">
                    ...
                    <span class="username">
                      ...
                      <a href="#" class="float-right btn-tool"><i class="fas fa-times" /></a>
                    </span>
                    <span class="description">Shared publicly - 7:30 PM today</span>
                  </div>
                  <!-- /.user-block -->
                  <p>
                    Lorem ipsum represents a long-held tradition for designers, typographers and the like. Some people hate it and argue for its demise, but others ignore the hate as they create
                    awesome tools to help create filler text for everyone from bacon lovers to Charlie Sheen fans.
                  </p>

                  <p>
                    <a href="#" class="link-black text-sm mr-2"><i class="fas fa-share mr-1" /> Share</a>
                    <a href="#" class="link-black text-sm"><i class="far fa-thumbs-up mr-1" /> Like</a>
              ...
              <div class="tab-pane" id="timeline">
                ...
                <div class="timeline timeline-inverse">
                  ...
                  <div>
                    ...
                    <div class="timeline-item">
                      <span class="time"><i class="far fa-clock" /> 2 days ago</span>
